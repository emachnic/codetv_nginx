...
default['nginx']['upstream_server_name'] = 'unicorn_server'
default['nginx']['codetv_root'] = '/vagrant/public'
default['nginx']['codetv_server_name'] = '_'
